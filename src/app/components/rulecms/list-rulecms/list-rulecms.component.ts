...
@Component({
  selector: 'app-list-rulecms',
  templateUrl: './list-rulecms.component.html',
  styleUrls: ['./list-rulecms.component.scss'],
  providers: [NgbCarouselConfig]
})
export class ListRulecmsComponent implements OnInit {

   // images = [1, 2, 3].map(() => `https://picsum.photos/900/500?random&t=${Math.random()}`);
 imageServer;
 imageToShow = [];
 constructor(private rulecmsService: rulecmsService, private ruleDataService: DataService, private config: NgbCarouselConfig) {
